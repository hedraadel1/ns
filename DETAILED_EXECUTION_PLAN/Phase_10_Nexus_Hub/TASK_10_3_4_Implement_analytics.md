...
**Objective:** Add per-contact analytics widgets in chat view.

**Requirement Traceability:** Analytics features (#35,#40)

**Technical Specs:**
- Class/Namespace: Vue component/page file
- File path(s): resources/js/Components/ContactAnalytics.vue
- Database tables: TBD
