...
**Objective:** Create the HedraSouly chat UI for agents and contacts.

**Requirement Traceability:** Collaboration features (#41,#42)

**Technical Specs:**
- Class/Namespace: Vue component/page file
- File path(s): resources/js/Pages/ChatInterface.vue
- Database tables: TBD
