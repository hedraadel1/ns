...
**Objective:** Add quick command buttons and agent triggers.

**Requirement Traceability:** Collaboration features (#49,#78)

**Technical Specs:**
- Class/Namespace: Vue component/page file
- File path(s): resources/js/Components/QuickActions.vue
- Database tables: TBD
