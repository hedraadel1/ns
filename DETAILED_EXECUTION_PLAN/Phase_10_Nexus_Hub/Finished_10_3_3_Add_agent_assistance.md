...
**Objective:** Add inline agent suggestions and assistance cards.

**Requirement Traceability:** Collaboration features (#41,#49)

**Technical Specs:**
- Class/Namespace: Vue component/page file
- File path(s): resources/js/Components/AgentAssist.vue
- Database tables: TBD
