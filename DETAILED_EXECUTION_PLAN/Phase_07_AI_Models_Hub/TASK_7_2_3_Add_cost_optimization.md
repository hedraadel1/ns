...
**Objective:** Choose lower-cost provider when acceptable.

**Requirement Traceability:** AI Models Hub features (#57)

**Technical Specs:**
- Class/Namespace: App\Services\AI\CostOptimizer
- File path(s): app/Services/AI/CostOptimizer.php
- Database tables: TBD
