...
**Objective:** Throttle provider requests and recover gracefully.

**Requirement Traceability:** AI Models Hub features (#73)

**Technical Specs:**
- Class/Namespace: App\Services\AI\RateLimitService
- File path(s): app/Services/AI/RateLimitService.php
- Database tables: TBD
