...
**Objective:** Define App\Services\AI\ProviderInterface and base provider class.

**Requirement Traceability:** AI Models Hub features (#80,#51)

**Technical Specs:**
- Class/Namespace: App\Services\AI\ProviderInterface
- File path(s): app/Services/AI/ProviderInterface.php
- Database tables: TBD
