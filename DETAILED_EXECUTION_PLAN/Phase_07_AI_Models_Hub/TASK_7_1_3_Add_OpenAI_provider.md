...
**Objective:** Implement OpenAI adapter and model options.

**Requirement Traceability:** AI Models Hub features (#80)

**Technical Specs:**
- Class/Namespace: App\Services\AI\OpenAIProvider
- File path(s): app/Services/AI/OpenAIProvider.php
- Database tables: TBD
