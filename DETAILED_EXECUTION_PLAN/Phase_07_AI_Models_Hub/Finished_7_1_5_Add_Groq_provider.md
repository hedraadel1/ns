...
**Objective:** Add Groq adapter for low-latency models.

**Requirement Traceability:** AI Models Hub features

**Technical Specs:**
- Class/Namespace: App\Services\AI\GroqProvider
- File path(s): app/Services/AI/GroqProvider.php
- Database tables: TBD
