...
**Objective:** Build agent type that introspects past actions and improves strategy.

**Requirement Traceability:** Self-Healing Infrastructure feature (#77)

**Technical Specs:**
- Class/Namespace: App\Agents\ReflectionAgent
- File path(s): app/Agents/ReflectionAgent.php
- Database tables: TBD
