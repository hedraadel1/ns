...
**Objective:** Expose searchable log UI and API filters.

**Requirement Traceability:** Logs Hub features

**Technical Specs:**
- Class/Namespace: App\Http\Controllers\LogController
- File path(s): app/Http/Controllers/LogController.php
- Database tables: TBD
