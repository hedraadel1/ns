...
**Objective:** Create alert rules for failures and security events.

**Requirement Traceability:** Security features (#66,#77)

**Technical Specs:**
- Class/Namespace: App\Services\AlertService
- File path(s): app/Services/AlertService.php
- Database tables: TBD
