# Create structured memory layer

**Objective:** Persist structured facts and relationships in MySQL.

**Requirement Traceability:** Memory Hub features (#1,#8)

**Technical Specs:**
- Class/Namespace: App\Services\Memory\StructuredMemoryService
- File path(s): app/Services/Memory/StructuredMemoryService.php
- Database tables: TBD
