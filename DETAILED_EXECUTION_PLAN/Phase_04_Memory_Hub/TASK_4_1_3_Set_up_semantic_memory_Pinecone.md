# Set up semantic memory (Pinecone)

**Objective:** Integrate vector DB for embeddings and semantic retrieval.

**Requirement Traceability:** Semantic Deep Search API feature (#80)

**Technical Specs:**
- Class/Namespace: App\Services\Memory\SemanticMemoryService
- File path(s): app/Services/Memory/SemanticMemoryService.php
- Database tables: TBD
