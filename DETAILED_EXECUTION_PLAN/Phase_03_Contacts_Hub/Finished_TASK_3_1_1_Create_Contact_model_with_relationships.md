...
**Objective:** Define App\Models\Contact and relations to conversations/messages/notes/tags.

**Requirement Traceability:** Contact Intelligence features (#1,#6,#9)

**Technical Specs:**
- Class/Namespace: App\Models\Contact
- File path(s): app/Models/Contact.php
- Database tables: TBD
