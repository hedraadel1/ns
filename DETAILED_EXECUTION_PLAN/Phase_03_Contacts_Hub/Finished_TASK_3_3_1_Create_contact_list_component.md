...
**Objective:** Build Vue component for paginated contact lists.

**Requirement Traceability:** UI features (#42,#44)

**Technical Specs:**
- Class/Namespace: Vue component/page file
- File path(s): resources/js/Components/ContactList.vue
- Database tables: TBD
