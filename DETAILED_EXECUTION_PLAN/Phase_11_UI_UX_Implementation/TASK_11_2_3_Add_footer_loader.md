...
**Objective:** Add persistent footer status bar and progress indicator.

**Requirement Traceability:** UI features

**Technical Specs:**
- Class/Namespace: Vue component/page file
- File path(s): resources/js/Components/FooterLoader.vue
- Database tables: TBD
