# Set up WAHA webhook endpoint

**Objective:** Create webhook route and controller for incoming WhatsApp requests.

**Requirement Traceability:** WAHA integration features

**Technical Specs:**
- Class/Namespace: route definition file, no class namespace
- File path(s): routes/api.php, app/Http/Controllers/WebhookController.php
- Database tables: TBD
