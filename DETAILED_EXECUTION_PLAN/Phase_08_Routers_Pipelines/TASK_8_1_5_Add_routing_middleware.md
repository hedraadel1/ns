...
**Objective:** Add middleware to tag requests with routing metadata.

**Requirement Traceability:** Architecture features

**Technical Specs:**
- Class/Namespace: App\Http\Middleware\RoutingMiddleware
- File path(s): app/Http/Middleware/RoutingMiddleware.php
- Database tables: TBD
