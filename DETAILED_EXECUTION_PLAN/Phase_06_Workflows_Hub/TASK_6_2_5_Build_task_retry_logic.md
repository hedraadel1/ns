# Build task retry logic

**Objective:** Retry failed steps with backoff and alert rules.

**Requirement Traceability:** Self-Healing Infrastructure feature (#77)

**Technical Specs:**
- Class/Namespace: App\Services\TaskRetryService
- File path(s): app/Services/TaskRetryService.php
- Database tables: TBD
