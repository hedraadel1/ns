...
- `resources/js/Pages/Components/LiveChatStream.vue`: New component for token-by-token LLM streaming
- `resources/js/Pages/Components/GlobalJobMonitor.vue`: New component for batch job progress
- `resources/js/Pages/Components/ConnectionStatus.vue`: New component for WebSocket connection indicator
- `resources/js/Pages/ChatInterface.vue`: Modify to use LiveChatStream component
- `resources/js/composables/useLiveChat.js`: New composable for chat streaming logic

## 3. Implementation Steps
1. **Create resources/js/Pages/Components/LiveChatStream.vue**
...
5. **Modify resources/js/Pages/ChatInterface.vue**
   - Import and use LiveChatStream component
   - Remove old REST polling logic for message updates
