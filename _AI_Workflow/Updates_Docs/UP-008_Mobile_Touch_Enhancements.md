...
- **Features & Details:**
  - Implement swipe-right-to-go-back gesture (J01)
  - Implement pull-to-refresh on all lists (J02)
  - Create `NxBottomSheet.vue` for mobile menus (J03)
  - Create `NxContextMenu.vue` for long-press context menus (J04)
  - Create `NxFab.vue` floating action button (J05)
